...
public class ReconciliationServicePractice
{
    ...
    public static void Main()
    {
        ...
        {
            List<Commitment> comm = perFundCommitments.TryGetValue(f.FundId, out var list) ? list : new();
        ...
        top3Funds.ForEach(f => Console.WriteLine($"top3Funds {f}"));
        orphans.ForEach(f => Console.WriteLine($"orphans {f.FundId}"));
    }
}
public class Fund
{
